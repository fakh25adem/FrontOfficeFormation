...
import AccueilTrans from './section-components/acc-trans';
const AccueilTransfertPage = () => {
    ...
    return(  <div>
        <Navbar />
        <Page_header5  headertitle="Accueil & Transfert"/>
        <AccueilTrans />
        <Footer />
        <Scrollp/>
...
export default AccueilTransfertPage
