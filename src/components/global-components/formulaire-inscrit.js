...
const FormulaireInscrit = () => {
    ...
    useEffect(() => {
        const fetchFormation = async () => {
            try {
                const response = await axios.get(`http://localhost:4500/api/Formation/formations/${formationCode}`); // Remplacez par l'URL de votre API
    ...
    return (
        <div className="container22 ">
            <div className="header22">
                <h2>Formulaire</h2>
                <p className="description">{formation.formationNom || 'Les processus et outils clés de planification et suivi-évaluation des projets et programmes de développement'}</p>
                <p><strong>Code de la formation:</strong> {formation.formationCode || 'EXP01'}</p>
                <p><strong>Durée de la formation:</strong> {formation.formationDuree || '2 semaines'}</p>
                <p><strong>Langue de la formation:</strong> {formation.formationLangue || 'Francais'}</p>
                <p><strong>Mode de la formation:</strong> {formation.mode || 'Présentiel'}</p>
            </div>
