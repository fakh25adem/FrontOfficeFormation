...
const FormComponent = () => {
    ...
    const domainesApiURL = "http://localhost:4500/api/Domaine/all";
    const sousDomainesApiURL = "http://localhost:4500/api/sousDomaine/iddomaine";
    ...
    return (
        <div className="catalogue-section" style={{backgroundImage: 'url('+publicUrl+'assets/img/institute/bg-lastest-new-now-2.jpg)',
                                        }}>
            <div className="form-container">
                ...
                <form>
                    ...
                    <h5>Date de la formation</h5>
                    <input type="date" placeholder="Date de la formation" />
                    <h5>Pays de la formation</h5>
                    <select name="pays">
