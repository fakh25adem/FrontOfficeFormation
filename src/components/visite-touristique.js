...
import VisitTourist from './section-components/visit-tourist';
const VisiteTouristPage = () => {
    ...
    return(  <div>
        <Navbar />
        <Page_header5  headertitle="Visites Touristiques"/>
        <VisitTourist />
        <Footer />
        <Scrollp/>
...
export default VisiteTouristPage
